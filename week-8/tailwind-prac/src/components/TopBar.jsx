export const TopBar = ({
    ...
    return (
<div className=" py-2 px-5 shadow-lg  bg-opacity-100">
            <div className=" bg-white flex justify-start font-medium font-sans text-lg items-center">Payouts

                <div className=" flex pl-2 font-extralight text-xs  ">

                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 -2 24 24" strokeWidth={1.5} stroke="currentColor" className="size-3">
                ...
                <div className="bg-slate-200  w-96 h-10 rounded-md flex ml-auto justify-center align-middle items-center ">
                    ...
                    <form action="" className='w-full'>
                        <input placeholder='Search features, tutorials, etc.' type="text" className='w-full bg-inherit text-base pl border-none focus:outline-none' />
                    </form>
                </div>

                <div className='flex  bg pl-4 h-10 ml-auto mr-1 justify-end  gap-4'>
